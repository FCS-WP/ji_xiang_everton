    ...
    if( $_SESSION['status_popup'] == false){
        ...
        <script>
            ...
            $(document).ready(function () {
                let productId = $('.action-popup-btn').attr('productid'); 
                $('.image-fade_in_back a').attr('href', '#order-popup-' + productId);
                $('.woocommerce-loop-product__title a').attr('href', '#order-popup-' + productId);
                $('.quick-view').hide()
            });
        </script>
        <?php

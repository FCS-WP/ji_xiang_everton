...
?>
	...
	public function quantity_html($markup, $cart_item, $cart_item_key)
	{
		...
		<div class="ux-mini-cart-qty">
			...
			if ($header_cart_qty) {
				$is_combo = isset($cart_item['akk_selected']);
				$class_combo = $is_combo ? 'combo-price-wrapper is-combo-product' : 'price-wrapper';
			?>
				<span class="product-subtotal <?php echo esc_attr($class_combo); ?>"
					id="<?php echo $is_combo ? 'combo-price-' . esc_attr($cart_item_key) : ''; ?>"
